...
## 0.0.5
  * Handle API 429 rate limits using the `Retry-After` response header. [#20](https://github.com/singer-io/tap-notion/pull/20)
  * Upgrade `singer-python`, `requests` packages to latest version
